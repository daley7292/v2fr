export default {
  ...
  "theme.form.theme_via": "Authorization Code",
  "theme.form.theme_via.placeholder": "Please enter the authorization code",
  "theme.form.theme_color.placeholder": "Please enter the theme color",
  "theme.form.custom_html": "Custom Footer (for inserting customer service JS code, etc.)",
  "theme.form.custom_html.placeholder.custom_html": "Custom JS code"
};
